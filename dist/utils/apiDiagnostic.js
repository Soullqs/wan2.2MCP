...
export class ApiDiagnostic {
    ...
    async diagnoseApiCall(model) {
        ...
        try {
            ...
            const response = await axios.post(`${this.baseURL}/api/v1/services/aigc/text2image/image-synthesis`, requestData, { headers, timeout: 30000 });
            details = {
